...
if (header) {
  ...
  /* All screens (like drukarov.com): the name isn't pinned — once you scroll
     past the hero it slides up 1:1 with the page, as if it were page content,
     so the header is only visible on the first page. */
